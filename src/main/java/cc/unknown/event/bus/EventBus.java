...
public final class EventBus<Event> implements Bus<Event>, Accessor {
    ...
    public void handle(final Event event) {
        try {
            if ((mc.theWorld == null || mc.getNetHandler() == null || (!ReflectUtil.getDoneLoadingTerrain() && !(event instanceof InboundEvent))) && !(event instanceof GameEvent || event instanceof WorldLoadEvent)) {
                return;
            }
