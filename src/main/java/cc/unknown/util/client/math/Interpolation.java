...
public final class Interpolation {
    public double interpolate(double from, double to, double percent, Type type, Ease ease) {
        switch (type) {
            case SINE:
    ...
    public double linearInterpolation(double from, double to, double percent) {
        return from + (to - from) * percent;
    }

    public double sineInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double quadInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
                percent *= percent;
                break;
    ...
    public double cubicInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double quartInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double quintInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double expoInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double circInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    public double backInterpolation(double from, double to, double percent, Ease ease) {
        double s = 1.70158;
        switch (ease) {
            case IN:
    ...
    public double bounceInterpolation(double from, double to, double percent, Ease ease) {
        switch (ease) {
            case IN:
    ...
    private double bounceOut(double percent) {
        if (percent < 1 / 2.75) {
    ...
    public double elasticInterpolation(double from, double to, double percent, Ease ease) {
        double p = 0.3;
        switch (ease) {
            case IN:
