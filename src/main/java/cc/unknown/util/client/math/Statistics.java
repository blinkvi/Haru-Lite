...
import cc.unknown.util.structure.comparators.Pair;
...
public final class Statistics {
    ...
    public long getMode(final Collection<? extends Number> array) {
    ...
    public float gcdRational(final List<Float> numbers) {
    ...
    public List<Long> convertToLongList(List<Integer> integerList) {
    ...
    public double getCoefficientOfVariation(final Collection<? extends Number> data) {
    ...
    public double getZScore(final double value, final Collection<? extends Number> data) {
        double mean = getAverage(data);
    ...
    public double getHarmonicMean(final Collection<? extends Number> data) {
        double sum = 0.0;
        int count = 0;
    ...
    public double getLinearTrend(final List<? extends Number> data) {
        int n = data.size();
        if (n < 2) return 0;
    ...
    public double getCovariance(final List<? extends Number> x, final List<? extends Number> y) {
        if (x.size() != y.size() || x.isEmpty()) return 0.0;
    ...
    public double getSharpeRatio(final Collection<? extends Number> returns, double riskFreeRate) {
        double mean = getAverage(returns);
        double stdDev = getStandardDeviation(returns);
        return stdDev == 0 ? 0 : (mean - riskFreeRate) / stdDev;
    }

    public double getQuantile(final Collection<? extends Number> data, double quantile) {
    ...
    public double getGiniIndex(final Collection<? extends Number> data) {
        List<Double> sorted = data.stream().map(Number::doubleValue).sorted().collect(Collectors.toList());
        int n = sorted.size();
        double sum = 0;
    ...
    private double pearsonCorrelation(List<? extends Number> x, List<? extends Number> y) {
        double meanX = getAverage(x);
        double meanY = getAverage(y);
    ...
    public double spearmanCorrelation(List<? extends Number> x, List<? extends Number> y) {
    ...
    public double rSquared(List<? extends Number> actual, List<? extends Number> predicted) {
    ...
    public double tTest(List<? extends Number> sample1, List<? extends Number> sample2) {
    ...
    public List<Double> movingAverage(List<? extends Number> data, int windowSize) {
    ...
    public List<Double> exponentialMovingAverage(List<? extends Number> data, double smoothingFactor) {
        List<Double> result = new ArrayList<>();
    ...
    public double[] linearRegression(List<? extends Number> x, List<? extends Number> y) {
        int n = x.size();
        double sumX = 0, sumY = 0, sumXY = 0, sumX2 = 0;
        for (int i = 0; i < n; i++) {
    ...
    public double regressionStandardError(
    ...
    public double getWinsorizedMean(List<? extends Number> data, double trimFraction) {
    ...
    public double kolmogorovSmirnovTest(final List<? extends Number> data, Function<Double, Double> cdfFunction) {
        List<Double> sorted = data.stream().map(Number::doubleValue).sorted().collect(Collectors.toList());
        int n = sorted.size();
        double dStatistic = 0;
        for (int i = 0; i < n; i++) {
    ...
    public double getExponentiallyWeightedVariance(final List<? extends Number> data, double alpha) {
    ...
    public double calculateAimSuspicionIndex(final List<? extends Number> aimDeltas,
    ...
    public List<Double> kalmanFilterPredict(final List<? extends Number> measurements,
    ...
    public double dynamicTimeWarpingDistance(final List<Double> series1, final List<Double> series2) {
        int n = series1.size();
        int m = series2.size();
    ...
    public List<Integer> cusumDetection(final List<? extends Number> data, double threshold, double drift) {
