...
public class HaloRenderer implements Accessor {
	...
	public static void drawArisHalo(RenderWorldLastEvent event) {
	...
	public static void drawShirokoHalo(RenderWorldLastEvent event) {
        float height = mc.thePlayer.height + 0.25f;
    ...
    public static void drawReisaHalo(RenderWorldLastEvent event) {
        float height = mc.thePlayer.height + 0.25f;
    ...
    public static void drawNatsuHalo(RenderWorldLastEvent event) {
        float height = mc.thePlayer.height + 0.25f;
    ...
    public static void drawHoshinoHalo(RenderWorldLastEvent event) {
        float height = mc.thePlayer.height + 0.25f;
    ...
    private static void glTranslated(RenderWorldLastEvent event, float height) {
        GL11.glTranslated(mc.thePlayer.lastTickPosX + (mc.thePlayer.posX - mc.thePlayer.lastTickPosX) * event.partialTicks - ReflectUtil.getRenderPosX(), mc.thePlayer.lastTickPosY + (mc.thePlayer.posY - mc.thePlayer.lastTickPosY) * event.partialTicks - ReflectUtil.getRenderPosY() + height, mc.thePlayer.lastTickPosZ + (mc.thePlayer.posZ - mc.thePlayer.lastTickPosZ) * event.partialTicks - ReflectUtil.getRenderPosZ());
    }
}