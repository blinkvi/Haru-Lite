...
public class FastPlace extends Module {
    ...
    private final ModeValue mode = new ModeValue("Mode", this, "Expert", "Simple", "Expert");

    private final SliderValue tick = new SliderValue("Ticks", this, 0, 0, 5, () -> mode.is("Simple"));
    private final SliderValue cps = new SliderValue("CPS", this, 10, 1, 25, () -> mode.is("Expert"));
    private final SliderValue deltaCPS = new SliderValue("DeltaCPS", this, 2, 0, 20, () -> mode.is("Expert"));
    ...
    private final StopWatch startDelay = new StopWatch();
    ...
    public void onPreAttack(PrePositionEvent event) {
        if (conditionals.isEnabled("Inventory") && mc.currentScreen instanceof GuiContainer) {
        	InventoryUtil.guiClicker(mc.currentScreen, 1, mode.is("Expert") ? (1000 / getRandomizedCPS()) : (long) (tick.getValue() * 50));
        }
    }
	...
	public void onRender3D(RenderWorldLastEvent event) {
        ...
        case "Expert":
        	...
        	break;
        case "Simple":
        	ReflectUtil.setRightClickDelayTimer((int) tick.getValue());
