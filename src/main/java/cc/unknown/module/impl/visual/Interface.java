...
public class Interface extends Module {
	...
	public final ModeValue color = new ModeValue("ArraylistColor", this, () -> elements.isEnabled("ArrayList"), "Slinky", "Fade", "Slinky", "Magic", "Neon", "Blaze", "Ghoul", "Static");
	...
	public final BoolValue noRenderScoreboard = new BoolValue("NoRenderScoreboard", this, false, () -> elements.isEnabled("Scoreboard"));
	...
	public int color(int counter, int alpha) {
		...
		case "Ghoul":
			...
			break;
		case "Fade":
			col = ColorUtil.swapAlpha(ColorUtil.colorSwitch(mainColor.get(), secondColor.get(), 1000.0F, counter, 70L, fadeSpeed.get()).getRGB(), alpha);
			break;
		case "Static":
