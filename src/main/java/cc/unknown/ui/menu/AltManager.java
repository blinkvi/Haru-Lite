...
public class AltManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawGradientRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), 0, Haru.instance.getModuleManager().getModule(Interface.class).color());
    ...
    public void actionPerformed(final GuiButton button) {
        ...
        case 1:        	
        	...
        	status = gray + "Logged as > " + green + name;
        	
        	((ISession) mc).setSession(new Session(name, "none", "none", "mojang"));        	
        	break;
        case 2:
        	status = gray + "Opening browser...";
