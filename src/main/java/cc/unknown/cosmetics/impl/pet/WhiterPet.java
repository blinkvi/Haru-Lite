package cc.unknown.cosmetics.impl.pet;
...
public class WhiterPet extends CosmeticBase {
	...
	public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		if (CosmeticController.shouldRenderCosmeticForPlayer(player, CosmeticType.WHITER) && !player.isInvisible()) {
			...
			playerRenderer.bindTexture(new ResourceLocation("textures/entity/wither/wither.png"));
