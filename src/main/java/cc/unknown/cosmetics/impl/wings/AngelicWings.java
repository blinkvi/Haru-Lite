...
public class AngelicWings extends ModelBase implements LayerRenderer<AbstractClientPlayer>, Accessor {
	private final RenderPlayer playerRenderer;
    ModelRenderer rightWing;
    ModelRenderer leftWing;

	public AngelicWings(RenderPlayer playerRendererIn) {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scalee) {
	    if (!entitylivingbaseIn.isInvisible() &&
	        ...
	        if (isWings(entitylivingbaseIn.getName()).equalsIgnoreCase("Angelic")) {
	            ...
	            String imagePath = WingsType.ANGELIC.getImagePath();					
